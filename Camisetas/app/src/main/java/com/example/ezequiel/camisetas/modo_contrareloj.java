...
import clases.MyCountDownTimer;
import clases.NumerosRandom;
import clases.pop;
import clases.popIncorrecto;
import clases.recordReloj;
import clases.tiempoFinalizado;

public class modo_contrareloj extends AppCompatActivity implements View.OnTouchListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_modo_contrareloj);
        ...
        //textView4.setVisibility(View.INVISIBLE); //Boton que oculta el texto Tiempo restante
    ...
    CountDownTimer timer = new MyCountDownTimer(20000, 1000) {
        @Override
        public void onTick(long millisUntilFinished) {
            tiempo.setText("Tiempo restante: " + millisUntilFinished / 1000);
        ...
        public void onFinish() {
            ...
            corregir.setEnabled(false);
            /*
            if (camisetasMessi.getText().toString() == "") {
                //textView4.setVisibility(View.INVISIBLE);
                tiempo.setText("¡TIEMPO AGOTADO! INTENTE DE NUEVO.");
            } else if (camisetasRonaldo.getText().toString() == "") {
                //textView4.setVisibility(View.INVISIBLE);
                tiempo.setText("¡TIEMPO AGOTADO! INTENTE DE NUEVO.");
            } else if (camisetasTotales.getText().toString() == "") {
                //textView4.setVisibility(View.INVISIBLE);
                tiempo.setText("¡TIEMPO AGOTADO! INTENTE DE NUEVO.");
            }
            */
            if((camisetasMessi.getText().toString() == "") ||  (camisetasRonaldo.getText().toString() == "") ||(camisetasTotales.getText().toString() == ""))  {
                ...
                Intent i =new Intent(modo_contrareloj.this, tiempoFinalizado.class);
                startActivity(i);
    ...
    public void validarCampos(){
        if((camisetasMessi.getText().toString() == "") ||  (camisetasRonaldo.getText().toString() == "") ||(camisetasTotales.getText().toString() == ""))  {
            Intent i = new Intent(modo_contrareloj.this, FinDeTiempo.class);
            startActivity(i);
            //tiempo.setText(" ");
            corregir.setEnabled(true);
            inicio.setEnabled(false);
    ...
    public void validarResultado(){
        ...
        int total = Integer.parseInt(totales);
        ...
        if ((rm == m ) && (rr == cr) && (total == totalCamisetas)){
            timer.cancel();
            inicio.setEnabled(true);
            Intent i =new Intent(modo_contrareloj.this, recordReloj.class);
            startActivity(i);//Esto iria donde verificamos si es correcto.
            win.start();//Activa el sonido si es correcto.
            //textView4.setVisibility(View.INVISIBLE);
            //tiempo.setText("¡¡FELICITACIONES, GANASTE!!");
        } else {
            startActivity(new Intent(modo_contrareloj.this, popIncorrecto.class));//Esto iria donde verificamos si es incorrecto.
            lose.start();//Activa el sonido si es incorrecto.
            //textView4.setVisibility(View.INVISIBLE);
            //tiempo.setText("¡¡LO SIENTO, PERDISTE!!");
        }
    }
